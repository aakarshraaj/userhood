...
export default function About() {
    ...
    useSEO({
        title: "About Userhood — Our Team, Story & Studio Culture",
        description: "Meet the team behind Userhood — design-obsessed engineers and creative strategists building world-class digital products, AI solutions, and brand systems.",
