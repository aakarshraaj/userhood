...
export default function Privacy() {
  useSEO({
    ...
    description: "How Userhood collects, uses, and protects your information when you engage with our product design, software development, and AI services.",
    canonical: "https://userhood.in/privacy",
  });
  return (
