...
export default function Terms() {
  useSEO({
    ...
    description: "Terms and conditions for engaging Userhood's product design, software engineering, AI integration, and brand & marketing services.",
    canonical: "https://userhood.in/terms",
  });
  return (
