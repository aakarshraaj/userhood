      ...
      <article>
        <header className="px-5 md:px-8">
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="mt-10 grid gap-10 md:mt-16 md:grid-cols-12 md:gap-12">
              ...
              <div className="md:col-span-4 md:self-end">
                <div className="border-l-2 border-primary/50 pl-5">
                  ...
                  <p className="mt-5 text-base font-light leading-relaxed text-slate-300">{data.summary}</p>
                </div>
              </div>
            </div>
            ...
            <dl className="mt-12 grid border-y border-white/10 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4">
              {data.facts.map((fact) => (
                <div key={fact.label} className="border-white/10 px-0 py-5 sm:px-5 sm:first:pl-0 sm:[&:nth-child(even)]:border-l lg:border-l lg:first:border-l-0 lg:last:pr-0">
                  <dt className="font-mono text-[0.7rem] uppercase tracking-[0.14em] text-white/60">{fact.label}</dt>
            ...
            <div className="grid border-b border-white/10 py-6 md:grid-cols-12 md:gap-10 md:py-8">
              <div className="font-mono text-[0.7rem] uppercase tracking-[0.16em] text-primary md:col-span-3">
        ...
        <section className="mt-16 border-y border-white/5 bg-[#08080a] px-5 py-16 md:mt-24 md:px-8 md:py-24">
          <div className="mx-auto grid max-w-[1280px] gap-10 md:grid-cols-12 md:gap-16">
            ...
            <div className="space-y-8 md:col-span-8">
              <p className="text-xl font-light leading-relaxed text-slate-200 md:text-2xl">{data.context}</p>
              <div className="border-l border-white/20 pl-6">
                <div className="font-mono text-xs uppercase tracking-[0.14em] text-white/65">The central challenge</div>
                <p className="mt-3 text-base font-light leading-relaxed text-slate-300 md:text-lg">{data.challenge}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-5 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-[1280px]">
            <div className="grid gap-8 border-b border-white/10 pb-10 md:grid-cols-12 md:items-end md:pb-12">
              ...
              <p className="text-base font-light leading-relaxed text-slate-300 md:col-span-4">
              ...
              {data.decisions.map((decision, index) => (
                <li key={decision.title} className="border-b border-white/10 py-10 md:py-14">
                  <div className="grid gap-6 md:grid-cols-12 md:gap-10">
                    ...
                    <p className="max-w-2xl text-base font-light leading-relaxed text-slate-300 md:col-span-7">{decision.detail}</p>
                  </div>
                  {decision.media && (
                    <ProjectMedia
                      project={data.brand}
          ...
          <div className="mx-auto grid max-w-[1280px] gap-10 md:grid-cols-12 md:gap-16">
            ...
            <div className="md:col-span-7">
              ...
              <div className="mt-8 border-l-2 border-primary/50 pl-6">
                ...
                <p className="mt-3 text-base font-light leading-relaxed text-slate-300">{data.evidenceBoundary}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-5 py-20 text-center md:px-8 md:py-28">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mx-auto mt-7 max-w-2xl text-base font-light leading-relaxed text-slate-300 md:text-lg">
            ...
            {data.trademarkNote && <p className="mt-12 text-xs leading-relaxed text-white/60">{data.trademarkNote}</p>}
          </div>
        </section>
      </article>
    </main>
