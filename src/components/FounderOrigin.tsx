                        ...
                        <div className="relative bg-[#0d0d0f] border border-white/5 p-6 md:p-8 lg:p-12 overflow-hidden flex flex-col items-center justify-center min-h-[320px] md:min-h-0 md:h-full">
                            ...
                            <div className="relative z-10 w-full flex justify-center gap-8 sm:gap-12 md:gap-20 mb-8 md:mb-16 mt-4 md:mt-8">
                                <div className="flex flex-col items-center group min-w-0">
                                    <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 lg:w-44 lg:h-44 rounded-full overflow-hidden mb-4 md:mb-8 border-2 md:border-4 border-white/10 group-hover:border-primary transition-all duration-300 shrink-0">
                                        <img src="/team/raj.png" alt="Raj, Co-Founder at Userhood" className="w-full h-full object-cover" loading="lazy" decoding="async" width="176" height="176" />
                                    </div>
                                    <h3 className="font-mono text-base md:text-xl text-white tracking-[0.2em] mb-1 md:mb-2">RAJ</h3>
                                    <div className="font-mono text-[10px] md:text-xs text-primary tracking-widest">CO-FOUNDER</div>
                                </div>
                                <div className="flex flex-col items-center group min-w-0">
                                    <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 lg:w-44 lg:h-44 rounded-full overflow-hidden mb-4 md:mb-8 border-2 md:border-4 border-white/10 group-hover:border-primary transition-all duration-300 shrink-0">
