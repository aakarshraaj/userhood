            ...
            <div className="max-w-[1440px] mx-auto relative z-10">
                ...
                <div className="grid lg:grid-cols-3 gap-4 md:gap-6">
                    {models.map((model, index) => (
                        ...
                        >
                            {model.featured && (
                                <div className="absolute top-0 left-0 right-0 md:left-auto md:right-0 bg-primary text-black font-mono text-[10px] uppercase tracking-widest px-3 py-1.5 font-bold text-center md:text-left">
                ...
                <div className="mt-10 md:mt-16 flex justify-center px-2">
                    <div className="inline-flex items-center gap-2 md:gap-3 border border-white/10 bg-white/5 px-4 py-2.5 md:px-6 md:py-3 font-mono text-xs md:text-[11px] text-white/60 tracking-widest uppercase text-center">
